...
public class Ticket implements Comparable<Ticket> {
    ...
    public void ImprimirConsumiciones(){
        ...
        HashMap<Integer, String> descripciones = mesa.getDescripciones();
        Set<Integer> lista = listaCantidades.keySet();
        Iterator<Integer> itr = lista.iterator();
        Integer codigo;
        while(itr.hasNext()){
            codigo = itr.next();
            System.out.println("Codigo Producto: "+""+codigo+", Descripcion: "+descripciones.get(codigo)+", Cantidad: "+listaCantidades.get(codigo)+", Precio: "+listaPrecios.get(codigo));
        }
    }
